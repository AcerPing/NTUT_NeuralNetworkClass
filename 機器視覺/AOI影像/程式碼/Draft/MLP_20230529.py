...
if __name__ == "__main__":
    ...
    base_dir = "D:\哲平\北科大_碩班_AI學程\碩一課程\314337 類神經網路\期末報告\AOI影像"
    
    p1 = os.path.join(base_dir, "OK\Perfect Defect CAM - OK\08q070012c6_L2_0122b_012613a_94_29_ROI0_OPOK.png")
    p2 = os.path.join(base_dir, "OK\Perfect Defect -OK\08q070012c6_L2_0122b_012613a_94_29_ROI0_OPOK.png")
    
    # p1=r"https://ww3.sinaimg.cn/bmiddle/007INInDly1g336j2zziwj30su0g848w.jpg"
    # p2="https://ww2.sinaimg.cn/bmiddle/007INInDly1g336j10d32j30vd0hnam6.jpg"
    
    img1 = cv2.imread(r"C:\Users\acer0\OneDrive\桌面\pic\08q070012c6_L2_0122b_012613a_94_29_ROI0_OPOK.png")
    img2 = cv2.imread(p2)
